...
# heightfield = random_rectangular_pillar(new_sub_terrain(), 1200, pillar_height).height_field_raw
...
######## test environment ########
heightfield = random_arc_pillar(new_sub_terrain(), 700, pillar_height).height_field_raw
# heightfield = random_line_pillar(new_sub_terrain(), 500, pillar_height).height_field_raw

######## etc ########
# triangle pillar
# heightfield = random_triangle_pillar(new_sub_terrain(), num_obs, pillar_height).height_field_raw
